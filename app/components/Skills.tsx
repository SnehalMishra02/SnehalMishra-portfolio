...
const Skills = () => {
  return (
        <div className="bg-gradient-to-b from-[#7950f2] via-[#7950f2] via-5% to-[#f783ac] to-95% h-screen w-full" id="Skills">
            <WaveDivider clr="#2a5298"/>
            <h1 className='text-white text-[250%] px-6 py-2 font-extrabold mt-7'>My Skills</h1>
            <div className='m-3 p-2 h-full w-full flex justify-center items-start'>
